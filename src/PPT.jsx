  ...
  // 🟣 7 — Thank You Outro
{
  ...
  content: (
    ...
    >
      ...
      {/* Main Thank You text */}
      <motion.h2
        className="text-6xl sm:text-7xl font-extrabold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text drop-shadow-md mb-4"
